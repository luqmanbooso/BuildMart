...
const Home = () => {
  ...
  const howItWorks = [
    ...
    {
      step: 4,
      title: "Browse and purchase premium materials directly from, all in one place.",
      description: "",
    },
  ];
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <span key={i} className={`text-yellow-400 text-xl ${i <= rating ? 'opacity-100' : 'opacity-30'}`}>
          ★
        </span>
      );
    }
    ...
    <div className="min-h-screen">
      ...
      <nav className="bg-white py-4 px-8 flex items-center justify-between shadow-sm">
        <div className="flex items-center">
          <img src="/logo.png" alt="BuildMart" className="h-10" />
        </div>
        <div className="flex items-center space-x-8">
          <a href="#" className="text-gray-800 hover:text-blue-800">Home</a>
          <a href="#" className="text-gray-800 hover:text-blue-800">Auction</a>
          <a href="#" className="text-gray-800 hover:text-blue-800">Shop</a>
          <a href="#" className="text-gray-800 hover:text-blue-800">About Us</a>
          <a href="#" className="text-gray-800 hover:text-blue-800">Contact Us</a>
          <button className="bg-gray-100 text-gray-800 p-2 rounded-full">
            <FaSearch />
          </button>
            ...
            <div className="max-w-md relative">
              ...
              <div className="relative z-10">
                <h1 className="text-3xl font-bold text-black leading-tight">
                  Find Trusted Professionals for Your Construction & Design Needs
                </h1>
                <button className="mt-6 bg-white border border-gray-300 text-gray-800 px-5 py-2 text-sm uppercase font-medium hover:bg-gray-100">
                  REGISTER NOW
                </button>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 -mt-16 relative z-20">
        <div className="grid grid-cols-4 bg-white shadow-lg">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className={`py-4 px-6 border-t-4 ${feature.borderColor} flex items-center justify-center min-h-32`}
            >
          ...
          <div className="flex items-center">
            ...
            <div className="w-1/2 pl-8">
              ...
              <p className="mt-8 text-gray-200">
                ...
                professionals for your needs, and shop for premium materials—all in 
                one place. Fast, transparent, and secure.
              </p>
          ...
          <div className="grid grid-cols-4 gap-6">
            {auctions.map((auction, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm">Budget: {auction.budget}</p>
                
                <div className="mt-6 flex items-center">
                  <span className={`h-3 w-3 rounded-full ${auction.active ? "bg-green-500" : "bg-orange-500"} mr-2`}></span>
                  <span className="text-xs text-gray-500">
                    auction {auction.active ? "ends" : "start"} in {auction.endDate}
                  </span>
                </div>
                
                <button className="mt-4 border border-gray-300 text-gray-800 px-6 py-2 w-full hover:bg-gray-100">
                  Bid now
                </button>
              </div>
            ))}
            ...
            {professionals.map((professional, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 text-sm mt-2">
                  <span className="font-semibold">Area:</span> {professional.area}
                </p>
                <p className="text-gray-600 text-sm">
                  <span className="font-semibold">Completed Requests:</span> {professional.completedRequests}
                </p>
                ...
                <div className="border-t border-gray-200 pt-4 mt-2">
                  <button className="bg-blue-800 text-white px-4 py-2 text-sm w-full hover:bg-blue-900">
                    More Details ››
                  </button>
                </div>
              </div>
            ...
            {products.map((product, index) => (
              <div key={index}>
                ...
                <div className="flex items-center mb-4">
                  <span className={`h-3 w-3 rounded-full ${product.active ? "bg-green-500" : "bg-orange-500"} mr-2`}></span>
                  <span className="text-xs uppercase text-gray-500">
                    {product.active ? "Active" : "Unavailable"}
                  </span>
                </div>
                
                <button className="border border-gray-300 text-gray-800 px-4 py-1 text-sm hover:bg-gray-100">
                  BUY
                </button>
              </div>
            ))}
            ...
            <div className="w-2/3">
              {howItWorks.map((step, index) => (
                <div key={index} className="flex items-start mb-10">
                  <div className="bg-blue-800 text-white rounded-full w-10 h-10 flex items-center justify-center mr-4 flex-shrink-0">
                    {step.step}
                  </div>
                  <div>
      ...
      <footer className="bg-blue-900 text-white py-12">
        <div className="container mx-auto px-12">
          <div className="flex">
            <div className="w-1/3">
              ...
              <p className="text-sm text-gray-300 mt-4">
                Your all-in-one platform for finding top-rated contractors and architects. Compare bids, connect with professionals, and ensure secure payments with our escrow system. Build smarter, faster, and hassle-free!
              </p>
            </div>
          ...
          <div className="flex justify-between items-center mt-12 pt-6 border-t border-blue-800">
            <p className="text-sm text-gray-300">© 2025 BuildMart - All rights reserved</p>
